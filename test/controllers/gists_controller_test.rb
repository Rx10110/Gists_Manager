...
class GistsControllerTest < ActionController::TestCase
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post :create, gist: { category_id: @gist.category_id, client_id: @gist.client_id, title: @gist.title }
    end
  ...
  test "should update gist" do
    patch :update, id: @gist, gist: { category_id: @gist.category_id, client_id: @gist.client_id, title: @gist.title }
    assert_redirected_to gist_path(assigns(:gist))
  end
